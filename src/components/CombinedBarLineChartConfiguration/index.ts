...
import { CombinedBarLineChartConfiguration } from './CombinedBarLineChartConfiguration';
...
function mount(containerId: string, props: any) {
  ...
  root.render(React.createElement(CombinedBarLineChartConfiguration, props));
}
...
(window as any).ReactWidgets['CombinedBarLineChartConfiguration'] = { mount, update, unmount };
