...
import { ColumnChart } from './CombinerBarLineChart';
...
function mount(containerId: string, props: any) {
  ...
  root.render(React.createElement(ColumnChart, props));
}
...
(window as any).ReactWidgets['ColumnChart'] = { mount, update, unmount };
