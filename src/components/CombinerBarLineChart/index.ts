...
import { CombinedBarLineChart } from './CombinerBarLineChart';
...
function mount(containerId: string, props: any) {
  ...
  root.render(React.createElement(CombinedBarLineChart, props));
}
...
(window as any).ReactWidgets['CombinedBarLineChart'] = { mount, update, unmount };
