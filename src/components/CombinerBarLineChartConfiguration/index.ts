...
import { ColumnChartConfiguration } from './CombinerBarLineChartConfiguration';
...
function mount(containerId: string, props: any) {
  ...
  root.render(React.createElement(ColumnChartConfiguration, props));
}
...
(window as any).ReactWidgets['ColumnChartConfiguration'] = { mount, update, unmount };
